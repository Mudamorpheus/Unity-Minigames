...
namespace Builder {
    ...
    public class iOSBuildConfig {
        ...
        [JsonProperty(PropertyName = "geolocation_localization_version")]
        public string GeolocationLocalizationVersion;
    ...
    public class BuildApps : MonoBehaviour {
        ...
        private const string BuildConfig = "-config";
        ...
        private static string GetBuildLocation(BuildTarget buildTarget) {
            ...
            if (indexOfBuildLocation >= 0) {
                ...
                var helperPath = Path.GetDirectoryName(Application.dataPath) + Path.DirectorySeparatorChar + helperName;
        ...
        private static void LoadBuildConfig(BuildTarget target) {
            ...
            var indexOfAndroidConfigName = System.Array.IndexOf(args, BuildConfig);
            if (indexOfAndroidConfigName >= 0) {
                indexOfAndroidConfigName++;
                configName = args[indexOfAndroidConfigName];
                configPath = configName;
            } else {
                configPath = Path.GetDirectoryName(Application.dataPath) + Path.DirectorySeparatorChar + configName;
            }
                ...
                case BuildTarget.Android: {
                    if (androidBuildConfig != null) {
                        ...
                        if (androidBuildConfig.KeystoreName == null ||
                            ...
                            throw new Exception("===>>> ERROR! Keystore is not set!");
                        }

                        PlayerSettings.Android.useCustomKeystore = true;
                        PlayerSettings.Android.keystoreName = Path.GetDirectoryName(Application.dataPath) +
        ...
        private static void CheckIosAppTracking() {
            if (GameObject.Find("GetAppTracking")) {
                if (FindObjectOfType<GetAppTrackingTransparencyStatus>()) {
                    _trackingExist = true;
                }    
            }
        }
        ...
        public static void DeveloperMode() {
            ...
            PlayerSettings.Android.targetSdkVersion = AndroidSdkVersions.AndroidApiLevelAuto;
        #elif UNITY_IOS
            PlayerSettings.applicationIdentifier = "com.luckyclub";
            PlayerSettings.iOS.appleDeveloperTeamID = "2U3WPY496T";
        ...
        private static void RemovePlugins() {
            const string smartNsPath = "Assets/Common/Editor/Scripts/Builder/SmartNS";
            const string helpersPath = "Assets/Helpers";
            const string packagesPath = "Assets/BasePackages";

            AssetDatabase.DeleteAssets(new[] {smartNsPath, helpersPath, packagesPath}, new List<string>());
        }
        ...
        static void iOSTestBuild() {
            ...
            IterateAllScenes(() => {
                if (!_trackingExist) {
                    throw new Exception("===>>> ERROR! GetAppTracking not found");
                }
