...
namespace AlmostEngine
{
    public class AssetUtils
    {
        ...
        public static T Create<T>(string name, string path = "Assets/Helpers/AlmostEngine", bool preventOverride = true) where T : ScriptableObject
        {
        ...
        public static T GetFirstOrCreate<T>(string name, string path = "Assets/Helpers/AlmostEngine") where T : ScriptableObject
        {
            T asset = GetFirst<T>();
            if (asset == null)
            {
        ...
        public static T GetOrCreate<T>(string name, string path = "Assets/Helpers/AlmostEngine") where T : ScriptableObject
        {
